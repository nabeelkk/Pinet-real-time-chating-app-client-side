...
const SideBar = () => {
    ...
    const { users,getUsers,selectedUser,setSelectedUser,unSeenMessages,setUnSeenMessages,messages } = useContext(ChatContext)
  ...
  return (
    <div className={`bg-[#8185B2]/10 h-full p-5 rounded-r-xl overflow-y-scroll text-white
        ...
        <div className='pb-5'>
            ...
            <div className='bg-[#282142] rounded-full flex items-center py-3 px-4 mt-5 gap-2 mt-5'>
